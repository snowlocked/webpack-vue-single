...
export default {
  get: function(url, params, success, failure) {
    return _api_base('GET', url, params, success, failure)
  },
  post: function(url, params, success, failure) {
    return _api_base('POST', url, params, success, failure)
  },
  put: function(url, params, success, failure) {
    return _api_base('PUT', url, params, success, failure)
  },
  delete: function(url, params, success, failure) {
    return _api_base('DELETE', url, params, success, failure)
  },
}